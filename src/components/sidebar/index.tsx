...
import { Home, LogOut, Package, Package2, PanelBottom, Settings, Settings2, ShoppingBag, User, Users } from "lucide-react";
                ...
                <nav className="flex flex-col items-center gap-4 px-2 py-5">
                    <TooltipProvider>
                        ...
                        <Tooltip>
                            ...
                            <Link href='#' className="flex h-9 w-9 shrink-0 items-center justify-center rounded-lg text-mutedd-foreground transition-colors hover:text-foreground">
